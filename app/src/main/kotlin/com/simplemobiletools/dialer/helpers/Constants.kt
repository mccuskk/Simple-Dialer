...
const val TAB_CATI = 128

const val ALL_TABS_MASK = TAB_CONTACTS or TAB_CATI or TAB_CALL_HISTORY

val tabsList = arrayListOf(TAB_CONTACTS, TAB_CATI, TAB_CALL_HISTORY)
